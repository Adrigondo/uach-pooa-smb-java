...
public class Luigi extends Hero {
    ...
    public Luigi(double x, double y, ImageLoader imageLoader) {
        super(x, y, imageLoader);
        remainingLives = 5;
    }

    public Luigi(double x, double y, ImageLoader imageLoader, float jumpForce, float moveSpeed, Dimension dimension,
            int remainingLives) {
