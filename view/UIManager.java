...
public class UIManager extends JPanel {
    ...
    public UIManager(GameEngine engine, int width, int height) {
        ...
        this.engine = engine;
        GUIFactory factory = engine.getFactory();

        mapSelection = new MapSelection();

        BufferedImage sprite = factory.imageLoader.loadImage("/sprite.png");
        this.heartIcon = factory.imageLoader.loadImage("/heart-icon.png");
        this.coinIcon = factory.imageLoader.getSubImage(sprite, 1, 5, 48, 48);
        this.selectIcon = factory.imageLoader.loadImage("/select-icon.png");
        this.startScreenImage = factory.imageLoader.loadImage("/start-screen.png");
        this.helpScreenImage = factory.imageLoader.loadImage("/help-screen.png");
        this.aboutScreenImage = factory.imageLoader.loadImage("/about-screen.png");
        this.gameOverScreen = factory.imageLoader.loadImage("/game-over.png");
